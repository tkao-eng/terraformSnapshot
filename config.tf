...
resource "sumologic_user" "terraformMarkShanUser" {
    firstName = Mark
     lastName = Shan
     isActive = true
     roleIds = [0000000000000005]
...
resource "sumologic_user" "terraformsaurabhvaidyaUser" {
    firstName = saurabh
     lastName = vaidya
     isActive = true
     roleIds = [0000000000000005]
...
resource "sumologic_user" "terraformCodyRecenoUser" {
    firstName = Cody
     lastName = Receno
     isActive = true
     roleIds = [0000000000000005]
...
resource "sumologic_user" "terraformBarakJacobUser" {
    firstName = Barak
     lastName = Jacob
     isActive = true
     roleIds = [0000000000000005]
}
resource "sumologic_user" "terraformPratikIndapUser" {
    firstName = Pratik
     lastName = Indap
     isActive = true
     roleIds = [0000000000000005]
...
resource "sumologic_user" "terraformMatthewKimUser" {
    firstName = Matthew
     lastName = Kim
     isActive = true
     roleIds = [0000000000000005]
...
resource "sumologic_user" "terraformMarcinDominiakUser" {
    firstName = Marcin
     lastName = Dominiak
     isActive = true
     roleIds = [0000000000000005]
...
resource "sumologic_user" "terraformKittyCaoUser" {
    firstName = Kitty
     lastName = Cao
     isActive = true
     roleIds = [0000000000000005]
...
resource "sumologic_user" "terraformCarterTuneUser" {
    firstName = Carter
     lastName = Tune
     isActive = true
     roleIds = [0000000000000005]
}
resource "sumologic_user" "terraformDhivagarGnanaratnamUser" {
    firstName = Dhivagar
     lastName = Gnanaratnam
     isActive = true
     roleIds = [0000000000000005]
}
...
resource "sumologic_user" "terraformEladMichaeliUser" {
    firstName = Elad
     lastName = Michaeli
     isActive = true
     roleIds = [0000000000000005]
...
resource "sumologic_user" "terraformKevinLiuUser" {
    firstName = Kevin
     lastName = Liu
     isActive = true
     roleIds = [0000000000000005]
...
resource "sumologic_user" "terraformStevenBaldwinUser" {
    firstName = Steven
     lastName = Baldwin
     isActive = true
     roleIds = [0000000000000005]
...
resource "sumologic_user" "terraformRishabhJainUser" {
    firstName = Rishabh
     lastName = Jain
     isActive = true
     roleIds = [0000000000000005]
...
resource "sumologic_user" "terraformMaiziLiaoUser" {
    firstName = Maizi
     lastName = Liao
     isActive = true
     roleIds = [0000000000000005]
...
resource "sumologic_role" "terraformAdministratorRole" {
    ...
    description = 
    filterPredicate = *
    users = [0000000000000003, 0000000000000005, 0000000000000009, 000000000000000B, 0000000000000010, 0000000000000011, 0000000000000014, 0000000000000017, 000000000000001B, 000000000000001D, 0000000000000020, 0000000000000024, 0000000000000027, 0000000000000029, 000000000000002D, 0000000000000031, 0000000000000033, 0000000000000037, 0000000000000038, 000000000000003C, 000000000000003E, 0000000000000041, 0000000000000046, 0000000000000047, 000000000000004A, 000000000000004F, 0000000000000051, 0000000000000053, 0000000000000057, 000000000000005B, 000000000000005D, 0000000000000061, 0000000000000063, 0000000000000066, 000000000000006A, 000000000000006D, 000000000000006F, 0000000000000071, 0000000000000076, 0000000000000079, 000000000000007C, 000000000000007D, 0000000000000080, 0000000000000083, 0000000000000088, 0000000000000089, 000000000000008E, 000000000000008F, 0000000000000094, 0000000000000097, 000000000000009A, 000000000000009B, 000000000000009E, 00000000000000A1, 00000000000000A6, 00000000000000A9, 00000000000000AA, 00000000000000AE, 00000000000000B0, 00000000000000B5, 00000000000000B7, 00000000000000B9, 00000000000000BD, 00000000000000C0, 00000000000000C4, 00000000000000C6, 00000000000000C8, 00000000000000CB, 00000000000000CE, 00000000000000D3, 00000000000000D4, 00000000000000D9, 00000000000000DA, 00000000000000DE, 00000000000000E2, 00000000000000E5, 00000000000000E8, 00000000000000EB, 00000000000000EC, 00000000000000F0, 00000000000000F4, 00000000000000F6, 00000000000000F8, 00000000000000FB, 00000000000000FE, 0000000000000102, 0000000000000105, 0000000000000107, 000000000000010C, 000000000000010E, 0000000000000112, 0000000000000115, 0000000000000116, 0000000000000119, 000000000000011C, 0000000000000120, 0000000000000123, 0000000000000125, 000000000000012A, 000000000000012B, 000000000000012E, 0000000000000131, 0000000000000135, 0000000000000138, 000000000000013A, 000000000000013E, 0000000000000141, 0000000000000143, 0000000000000148, 000000000000014A, 000000000000014D, 0000000000000150, 0000000000000152, 0000000000000156, 0000000000000159, 000000000000015B, 000000000000015F, 0000000000000161, 0000000000000165, 0000000000000168, 000000000000016A, 000000000000016E, 0000000000000172, 0000000000000173, 0000000000000177, 0000000000000179, 000000000000017D, 0000000000000181, 0000000000000182, 0000000000000186, 0000000000000189, 000000000000018C, 000000000000018F, 0000000000000192, 0000000000000194, 0000000000000197, 000000000000019B, 000000000000019E]
